...
json_file = os.path.join("C://Users//Wakch//OneDrive//Desktop//stoic salamander//Tiaa bank//loanrate//loanrate//spiders//data//bankrate.json")
csv_file = os.path.join("C://Users//Wakch//OneDrive//Desktop//stoic salamander//Tiaa bank//loanrate//loanrate//spiders//data//bankrates.csv")
# === Required Fields ===
FIELDS = [
    "loan_product",
    "interest_rate",
...
def main():
    ...
    print(":information_source: JSON file was NOT modified and remains unchanged.")
